<template>
    <div id="entete" class="bg-linear-to-t from-primary to-blue-900 drop-shadow-lg ">
      <div class="head_pos">
      <!-- Logo Header -->
      <div>
        <img class="w-40 m-4" src="../Images/alto_prod_logo.png" alt="Logo Alto" />
      </div>
  
      <!-- Texte ALTO en arrière-plan -->
      <div class="w-full h-full overflow-hidden">
        <div class="flex justify-around opacity-10 w-full h-full items-center text-blue-500">
          <p class=" text-9xl border-15 font-semibold transform scale-250 truncate ">ALTO CPSS</p>
        </div>
      </div>
      ...
      <div class="flex flex-row items-center m-4">
        <div class="inline-block w-16 h-16 bg-secondary rounded-full overflow-hidden mr-5">
          <svg class="w-full h-full text-gray-300" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
